  ...
  return (
    <div className="mx-auto container mb-5">
      <div className="flex gap-3 p-5 items-center">
        <Link href="/" className=" bg-gray-100 p-3 px-5 block tetx-3xl">
      ...
      <div className="border-slate-300 mb-5 flex items-center gap-60 flex-wrap justify-center p-7 border w-full">
        ...
        <div>
          <Link href={userDetail.html_url}>
            <button
              type="submit"
              className="border-gray-700 rounded-lg bg-zinc-500 hover:bg-zinc-600 p-2 mb-6 text-xl px-3 text-white border"
            >
              Посетить профиль
            </button>
          </Link>
